public abstract class Player {
    ...
    public void setNumber_of_bombs(int bombs) {this.number_of_bombs=bombs;}
    public void setNumber_of_unflippedable(int unflippedable) {this.number_of_unflippedable=unflippedable;}
